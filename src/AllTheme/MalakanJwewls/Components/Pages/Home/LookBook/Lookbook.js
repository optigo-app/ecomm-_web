    ...
    <div className="mala_LookBookMain">
      ...
      {isProdLoading ? (
        ...
        <div className="smr1_LookBookSubMainDiv">
          ...
          >
            <div className="mala_lookBook_FilterIconeDiv" onClick={handleFilterShow} style={{ fontSize: '12px' }}>
          ...
          <div className="mala_SubDiv_LookBookSubMainDiv">
            <div className="mala_lookbookFilterMain" style={{ transition: "1s ease",backgroundColor:'white', zIndex: '1111111111111', width: `19%`, left: `${isShowfilter ? "0" : "-500%"}`, position: 'absolute', top: '100px', display: isShowfilter ? "block" : "none" }}>
