        ...
        <div className='mt-5' style={{marginTop: '50px'}}>
            <div className='promo-daimondBoxMain'>
                <div className='promo-daimondBox2'>
                    <img src={`${storImagePath()}/Elvee/images/HomePage/Promo/Banner/PromoBanner1.jpg`} loading="lazy" className='promo-daimondBox2-image' onClick={() => navigation('/productpage')}/>
                </div>
