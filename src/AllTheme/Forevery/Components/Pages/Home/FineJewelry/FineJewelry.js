                ...
                <div className="for_fineJewel_container_div">
                    <div className="for_fineJewel_breadcrumbs_div">
                        <div className="for_fineJewel_breadcrumbs">
                            <span className='for_fineJewel_breadcrumbs_label' onClick={() => navigate('/')}>Home /</span>
                            <span className='for_fineJewel_breadcrumbs_label'>&nbsp;Fine Jewelry</span>
                        </div>
                    </div>
                        ...
                        {fineJewelArr?.map((item) => {
                            ...
                            return (
                                <div className="" style={{
                                    ...
                                    <div className="for_fineJewel_banner_text_div" style={{ textAlign: isEven ? 'right' : "left" }}>
                                        <h1
                                            style={{
                                        ...
                                        <div className="for_fineJewel_para" style={{
                                            display: "flex",
                                        ...
                                        <div className="for_fineJewel_btn_div">
                                            <button className={`${btnstyle?.btn_for_new} for_finrJewel_btn ${btnstyle?.btn_15}`}>{item?.buttonText}</button>
                                        </div>
                                    </div>
                                </div>
                            )
