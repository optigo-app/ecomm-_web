...
const CartItem = ({
  ...
  return (
    ...
    >
      <Card
        className={itemLength <= 3 ? "dt_cartListCard" : "dt_cartListCard"}
        key={item?.id}
        sx={{
          boxShadow:
            !multiSelect &&
            ...
            "rgb(175 130 56 / 68%) 1px 1px 1px 0px, rgb(175 130 56 / 68%) 0px 0px 0px 1px !important",
              ...
              <Skeleton
                sx={{
                  ...
                  "@media (max-width:600px)": {
                    height: 240, // Adjust height for small screens
                    width: 160, // Adjust width for small screens
                  },
                  "@media (min-width:600px) and (max-width:960px)": {
                    height: 260, // Adjust height for medium screens
                    width: 180, // Adjust width for medium screens
                  },
                  "@media (min-width:960px)": {
                    height: 300, // Adjust height for large screens
                    width: 200, // Adjust width for large screens
                  },
                }}
              />
              Explanation: sx
              ...
              >
                <div>
                  {storeInitData?.IsGrossWeight == 1 && (
                    <Typography
                      variant="body2"
                      className="dt_card-ContentsData"
                    >
