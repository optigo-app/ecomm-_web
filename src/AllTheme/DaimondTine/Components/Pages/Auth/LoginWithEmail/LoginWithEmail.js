          ...
          <div className="dt_loginSubDiv">
            ...
            >
              <TextField
                ...
                aria-invalid={!!errors.confirmPassword} // Indicates if the input has an error
              ...
              <button
                aria-label="Submit the login form with password"
              ...
              <Button
                ...
                aria-label="Cancel login and return to login options"
              >
                CANCEL
              </Button>

              <button
                aria-label="Log in with a code instead of email"
                type="submit"
                className="submitBtnForgot"
