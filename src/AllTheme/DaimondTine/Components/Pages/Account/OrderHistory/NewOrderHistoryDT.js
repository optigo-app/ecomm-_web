                      ...
                      <Card variant="outlined" sx={{ boxShadow: "none", width: "100%", margin: "20px 0px", border: "1px solid #cacaca", }} key={i} >
                        ...
                        >
                          ...
                          >
                            ...
                            { orderDetails?.length > 1 && <Typography Typography className="fs_head_acc" style={{width:'100%', display:'flex', marginTop:'0.7%', justifyContent:'center', alignItems:'center', color:'grey'}} onClick={() => {
