    ...
    <Typography
      sx={{
        ...
        fontSize: {
          ...
          xl: "16px !important", // Extra large screens
        },
      }}
    >
      {text}
          ...
          >
            ...
            >
              ...
              <div className="sec_hoq_right">
                <HtmlTooltip
                  title={
                    <CustomTooltipContent categories={selectedCategories} />
                  }
                >
                  <button
                    onClick={() => handleOpen()}
...
// <div
// className="hoq_lookbookFilterMain"
// style={{
//   transition: "1s ease",
//   backgroundColor: "white",
//   zIndex: "999",
//   width: `19%`,
//   left: `${isShowfilter ? "0" : "-500%"}`,
//   position: "absolute",
//   top: "100px",
